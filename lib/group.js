...
module.exports = {
    ...
    resolve: function () {
        ...
        if (this.groupData.sources instanceof Array) {
            this.groupData.load = this.groupData.load.concat(this.groupData.sources);
        }

        if (this.groupData.libs instanceof Array) {
            this.groupData.load = this.groupData.load.concat(this.groupData.libs);
        }

        if (this.groupData.deps instanceof Array) {
            this.groupData.load = this.groupData.load.concat(this.groupData.deps);
        }

        if (this.groupData.specs instanceof Array) {
            this.groupData.load = this.groupData.load.concat(this.groupData.specs);
        }

        if (this.groupData.tests instanceof Array) {
            this.groupData.load = this.groupData.load.concat(this.groupData.tests);
        }
